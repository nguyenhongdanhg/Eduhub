...
def get_embedding_config() -> EmbeddingConfig:
    ...
    dim_str = _strip_value(os.getenv("EMBEDDING_DIMENSION")) or _strip_value(os.getenv("EMBEDDING_DIM"))

    if not model and binding == "sentence_transformers":
    ...
    providers_without_key = ["ollama", "lm_studio", "sentence_transformers"]
    providers_without_host = ["sentence_transformers"]
