...
def get_principal_document_preset(preset_id: str | None) -> dict:
...
def get_principal_document_prompt(preset_id: str | None) -> str:
  item = get_principal_document_preset(preset_id)
